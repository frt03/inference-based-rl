...
from pfrlx.experiments.tester import AsyncTester
from pfrlx.utils import async_
from pfrlx.utils import random_seed
        ...
        while True:
            ...
            if done or reset or global_t >= steps or stop_event.is_set():
                ...
                if tester is not None:
                    eval_score = tester.evaluate_if_necessary(
...
def train_agent_async(
    ...
    Args:
        ...
        global_step_hooks (list): List of callable objects that accepts
            ...
            step. See pfrlx.experiments.hooks.
