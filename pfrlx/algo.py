# https://github.com/pfnet/pfrl/blob/master/pfrl/agent.py
import contextlib
import os
...
class Algo(object, metaclass=ABCMeta):
    """Abstract algo class."""
...
class BatchAlgo(Algo, metaclass=ABCMeta):
    """Abstract algo class that can interact with a batch of envs."""
