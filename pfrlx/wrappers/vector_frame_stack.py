...
from pfrlx.env import VectorEnv
from pfrlx.wrappers.atari_wrappers import LazyFrames
...
class VectorFrameStack(VectorEnvWrapper):
    """VectorEnv analog to pfrlx.wrappers.atari_wrappers.FrameStack.

    The original `pfrlx.wrappers.atari_wrappers.FrameStack` does not work
    properly with `pfrlx.envs.MultiprocessVectorEnv` because LazyFrames
