...
from pfrlx.utils.recurrent import concatenate_recurrent_states
from pfrlx.utils.recurrent import flatten_sequences_time_first
from pfrlx.utils.recurrent import recurrent_state_from_numpy
...
class ReplayUpdater(object):
    ...
    def update_if_necessary(self, iteration):
        ...
        Returns:
            bool: True if the condition was updated this time.
        """
