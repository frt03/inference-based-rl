...
@hydra.main(config_path='../conf/mpo2/default.yaml')
def main(conf: DictConfig):
    ...
    variancescaling_init(policy[2].weight, scale=0.33, mode='fan_out', distribution='uniform')
    variancescaling_init(policy[4].weight, scale=0.33, mode='fan_out', distribution='uniform')
    variancescaling_init(policy[6].weight, scale=1e-4)
    torch.nn.init.zeros_(policy[6].bias)
    ...
    variancescaling_init(q_func[3].weight, scale=0.33, mode='fan_out', distribution='uniform')
    variancescaling_init(q_func[5].weight, scale=0.33, mode='fan_out', distribution='uniform')
    variancescaling_init(q_func[7].weight, scale=0.33, mode='fan_out', distribution='uniform')
